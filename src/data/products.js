...
export const categories = [
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "desk-accessories", name: "Staplers & Clips" },
    ],
  },
  {
    id: "paper",
...
export const products = [
  ...
  { id: "rollerball", name: "Metal Rollerball Pen", category: "fine-writing", sub: "ballpoint-rollerball", price: 1650, images: ["/Products/desk/rollerball.jpg"] },
  ...
  { id: "deskzen", name: "DeskZen Desk Organiser", category: "organisers", sub: "desk-organisers", price: 2499, tag: "Bestseller", images: ["/Products/desk/deskzen.jpg"] },
  ...
  { id: "box-file", name: "Lever Arch Box File — Blue", category: "organisers", sub: "file-trays", price: 690, images: ["/Products/desk/box-file.jpg"] },
  { id: "stapler", name: "Heavy-duty Office Stapler", category: "organisers", sub: "desk-accessories", price: 1150, images: ["/Products/desk/stapler.jpg"] },
  { id: "paper-clips", name: "Paper Clips in Clear Dispenser — 100", category: "organisers", sub: "desk-accessories", price: 250, images: ["/Products/desk/paper-clips.jpg"] },
  { id: "spiral-a5", name: "Spiral Notebook A5", category: "paper", sub: "notebooks", price: 350, images: ["/Products/desk/spiral-a5.jpg"] },
  { id: "register-200", name: "Single Line Register — 200 pages", category: "paper", sub: "registers", price: 320 },
  { id: "sticky-cube", name: "Sticky Notes Cube", category: "paper", sub: "sticky-notes", price: 420, images: ["/Products/desk/sticky-cube.jpg"] },
  ...
  { id: "highlighters", name: "Neon Highlighters — Set of 4", category: "school", sub: "colours-markers", price: 480, images: ["/Products/desk/highlighters.jpg"] },
